  ...
  describe('when do a post at /transactions', () => {
    describe('and has enough balance', () => {
      ...
      describe('and has a invalid amount', () => {
        it('response with 400 and message "invalid amount"', () => request(app)
      ...
      describe('and has a invalid TYPE', () => {
        it('response with 400 and message "invalid type"', () => request(app)
          .post('/api/transactions')
      ...
      describe('and has a valid amount and type', () => {
        it('response with 201 and the transaction ', () => request(app)
          .post('/api/transactions')
  ...
  describe('when do a get at /transactions/:id', () => {
    describe('and this transaction exists', () => {
      const transaction = Transaction.fromJson({
        id: 20, amount: 40, type: CREDIT, effectiveDate: ''
      });
      beforeAll(() => {
