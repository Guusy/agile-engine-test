...
const {
  NotEnoughBalanceException, TransactionNotFoundException, InvalidTransactionId, InvalidTypeException
} = require('../errors');
  ...
  describe('when want to add a transaction', () => {
    ...
    describe('and has a invalid type', () => {
      ...
      it('throws InvalidTypeException', async () => {
        const addTransaction = () => TransactionService.add(transaction);
